    ...
    <div class="media">
      <div class="media-left">
        <div class="avatar avatar-md avatar-circle">
          <a href="Profile"><img class="img-responsive" src="../assets/images/221.jpg" alt="avatar"/></a>
        </div><!-- .avatar -->
      </div>
      <div class="media-body">
        <div class="foldable">
          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu animated flipInY">
                ...
                <li>
                  <a class="text-color" href="javascript:fn_secession();" id="secession">
      ...
      <ul class="app-menu">
        ...
        <li class="has-submenu">
          ...
          <ul class="submenu">
            ...
            <li><a href="TradingtList"><span class="menu-text">거래명세서</span></a></li>
            <li><a href="TimeDiary"><span class="menu-text">방명록</span></a></li>         
          </ul>
        </li>
...
function fn_secession(){
	...
	if(confirm('정말 탈퇴?')){ 
		let mb_id = '${sessionScope.sess_id}';
